import yaml
from yolov7main.vietnameseocr.vietocr.tool.utils import download_config
...
class Cfg(dict):
    ...
    def load_config_from_device():
        path = './vietocr/tool/fake_config.txt'
        with open(path, mode= 'r', encoding= 'utf-8') as config_text:
            content = config_text.read()
